...
class TLDetector(object):
    ...
    def get_closest_waypoint(self, pose):
        ...
        """
        # this is a nearest neighbours search problem, not a closest pair of points problem
        # Sort waypoint
    ...
    def process_traffic_lights(self):
        ...
        # NOTE, above stop_line_positions is based on the sim_traffic_light_config.xml
