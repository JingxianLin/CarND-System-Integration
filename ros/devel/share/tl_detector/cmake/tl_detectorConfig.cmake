...
if("TRUE" STREQUAL "TRUE")
  set(tl_detector_SOURCE_PREFIX /home/metal-box/Desktop/CarND-Capstone-release-1.0/ros/src/tl_detector)
  set(tl_detector_DEVEL_PREFIX /home/metal-box/Desktop/CarND-Capstone-release-1.0/ros/devel)
  ...
  set(tl_detector_INSTALL_PREFIX /home/metal-box/Desktop/CarND-Capstone-release-1.0/ros/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tl_detector' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/metal-box/Desktop/CarND-Capstone-release-1.0/ros/src/tl_detector/${idir}'.  Ask the maintainer 'yousuf <yousuf@todo.todo>' to fix it.")
    endif()
